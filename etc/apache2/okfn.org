<VirtualHost *:80>
	ServerName okfn.org
 	ServerAlias www.okfn.org openknowledgefoundation.org www.openknowledgefoundation.org wsfii.org www.wsfii.org
...
# see the directory listing for research PDFs

<Directory /var/www/okfn.org/geo/pdf>
	Options +indexes
</Directory>

ScriptAlias /geo/wiki  "/var/moin/okfn_geo_wiki/moin.cgi"
...
RewriteEngine on
RewriteCond %{HTTP_HOST}  wsfii.org$     [NC]
RewriteCond %{REQUEST_URI} !^/wsfii/.*$
RewriteRule ^(.*)$  http://www.okfn.org/wsfii$1 [R]
