server {
	...
	###Rewrite Rules####
	rewrite ^browser/$ browser/index.php?l=en&p=1;
	rewrite ^browser/search(.*)$ browser/index.php?l=en&p=100;
	rewrite ^browser/pss-specification(.*)$ browser/index.php?l=en&p=101;
	rewrite ^browser/pss-change-notes(.*)$ /index.php?l=en&p=105;
	rewrite ^browser/pss-history(.*)$ /index.php?l=en&p=106;
	rewrite ^browser/pss-profile(.*)$ /index.php?l=en&p=107;
	...
	location /  {
		proxy_pass http://blog.okserver.org;
		proxy_set_header Host $host;
		proxy_redirect off;
		proxy_set_header X-Real-IP $remote_addr;
		proxy_set_header X-Forwarded-For $proxy_add_x_forwarded_for;
