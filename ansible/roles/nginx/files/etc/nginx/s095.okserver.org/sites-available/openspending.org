...
server {
  ...
  # blog
  rewrite ^/blog/index.html$ http://community.openspending.org/ permanent;
  rewrite ^/blog/feed.rss$   http://community.openspending.org/feed/ permanent;
  rewrite ^/blog/?$          http://community.openspending.org/ permanent;
  rewrite ^/blog/(.*).html$  http://community.openspending.org/$1/ permanent;

  # resources
  rewrite ^/resources/ http://community.openspending.org/research$request_uri permanent;
